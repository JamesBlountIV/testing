...
test(`"StudentQuestions" should render its props correctly`, () => {
    act( () => {
        ReactDOM.render(<StudentQuestions questions={["How are you", "Hows it going", "Why are you in my house"]}/>, container);
    })
    ...
    expect(h1Three.textContent).toBe("3: Why are you in my house");    
});
...
test("Removes a question when the answer button is clicked", () => {
    act( () => {
        ReactDOM.render(<App />, container);
    })
